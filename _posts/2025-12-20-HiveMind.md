...
After a Delphi or Dare-Share-Care evaluation session, you end up with a large volume of unstructured student responses — observations, concerns, suggestions — spread across many groups.
Reading and synthesizing all of that manually is time-consuming, and patterns that span multiple groups are easy to miss.
...
<img src="assets/img/hivemind/conceptmodel.png" width="50%" height="auto">


[Try it](https://hivemind-yn3i5.ondigitalocean.app)