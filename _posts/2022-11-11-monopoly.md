...
<script type="text/javascript" src="/assets/js/monopolyJS/main.js" ></script>

<p>
A generative art engine that will create a unique image based on the outcome of a single game of Monopoly. 
</p>
<div id="monopolyJS">
Keypress 'r' to run<br>
Keypress 'e' to end<br>
Keypress 's' to take snapshot</div>
<p>
...
<img width="100%" height="auto" src = "assets/img/monopoly/monopoly.jpg"/>
